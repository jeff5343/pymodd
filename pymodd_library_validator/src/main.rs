...
use pymodd_library_validator::{
    fetch_modd_io_editor_data, geneerate_function_class_from_object,
    generate_action_function_from_object, Object, ObjectType,
};
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let editor_data = fetch_modd_io_editor_data()?;
    ...
    if !missing_actions.is_empty() {
        ...
        write!(
            ...
            "# auto generated by the pymodd_library_validator\n\n\n{}",
            missing_actions
                .iter()
                .map(|action_object| {
                    format!(
